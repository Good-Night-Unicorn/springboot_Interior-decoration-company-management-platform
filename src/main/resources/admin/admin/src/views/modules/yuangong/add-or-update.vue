	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="员工电话" prop="yuangongdianhua">
					<el-input v-model="ruleForm.yuangongdianhua" placeholder="员工电话" clearable  :readonly="ro.yuangongdianhua"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="员工电话" prop="yuangongdianhua">
