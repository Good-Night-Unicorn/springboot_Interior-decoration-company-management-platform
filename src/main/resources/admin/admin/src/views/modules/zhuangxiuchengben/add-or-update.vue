	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="材料成本" prop="cailiaochengben">
					<el-input-number v-model="ruleForm.cailiaochengben" placeholder="材料成本" :disabled="ro.cailiaochengben"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="材料成本" prop="cailiaochengben">
					<el-input v-model="ruleForm.cailiaochengben" placeholder="材料成本" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="人工成本" prop="rengongchengben">
					<el-input-number v-model="ruleForm.rengongchengben" placeholder="人工成本" :disabled="ro.rengongchengben"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="人工成本" prop="rengongchengben">
					<el-input v-model="ruleForm.rengongchengben" placeholder="人工成本" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="其他成本" prop="qitachengben">
					<el-input-number v-model="ruleForm.qitachengben" placeholder="其他成本" :disabled="ro.qitachengben"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="其他成本" prop="qitachengben">
					<el-input v-model="ruleForm.qitachengben" placeholder="其他成本" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="装修成本" prop="zhuangxiuchengben">
					<el-input v-model="zhuangxiuchengben" placeholder="装修成本" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.zhuangxiuchengben" label="装修成本" prop="zhuangxiuchengben">
					<el-input v-model="ruleForm.zhuangxiuchengben" placeholder="装修成本" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="所得利润" prop="suodelirun">
					<el-input v-model="suodelirun" placeholder="所得利润" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.suodelirun" label="所得利润" prop="suodelirun">
					<el-input v-model="ruleForm.suodelirun" placeholder="所得利润" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="装修详情" prop="zhuangxiuxiangqing">
					<el-input
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.zhuangxiuxiangqing" label="装修详情" prop="zhuangxiuxiangqing">
					<span :style='{"fontSize":"14px","lineHeight":"40px","minWidth":"400px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.zhuangxiuxiangqing}}</span>
				</el-form-item>
...
export default {
	data() {
		...
		return {
			...
			ro:{
				...
				dengjishijian : false,
				dingdanjine : false,
				cailiaochengben : false,
				rengongchengben : false,
				qitachengben : false,
				zhuangxiuchengben : false,
				suodelirun : false,
	...
	computed: {
		suodelirun : {
			get: function () {
				let c = this.ruleForm
				let a = c.dingdanjine-c.zhuangxiuchengben
				this.ruleForm.suodelirun = a?Number(a).toFixed(2):0
		...
		zhuangxiuchengben: {
			get: function () {
				return 0+parseFloat(this.ruleForm.cailiaochengben==""?0:this.ruleForm.cailiaochengben)+parseFloat(this.ruleForm.rengongchengben==""?0:this.ruleForm.rengongchengben)+parseFloat(this.ruleForm.qitachengben==""?0:this.ruleForm.qitachengben) || 0
			}
		},
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='cailiaochengben'){
							this.ruleForm.cailiaochengben = obj[o];
							this.ro.cailiaochengben = true;
							continue;
						}
						...
						if(o=='qitachengben'){
							this.ruleForm.qitachengben = obj[o];
							this.ro.qitachengben = true;
							continue;
						}
						if(o=='zhuangxiuchengben'){
							this.ruleForm.zhuangxiuchengben = obj[o];
							this.ro.zhuangxiuchengben = true;
							continue;
						}
						if(o=='suodelirun'){
							this.ruleForm.suodelirun = obj[o];
							this.ro.suodelirun = true;
							continue;
						}
    ...
    // 提交
    onSubmit() {
		if(this.ruleForm.suodelirun==0){
			this.$message.error('所得利润不能为空')
			return false
		}
        this.ruleForm.zhuangxiuchengben = this.zhuangxiuchengben
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `zhuangxiuchengben/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.zhuangxiuchengbenCrossAddOrUpdateFlag = false;
											this.parent.search();
