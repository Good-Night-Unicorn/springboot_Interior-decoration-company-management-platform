<template>
  <div :style='{"padding":"30px","flexWrap":"wrap","display":"flex"}'>
    ...
    >  
     <el-row>
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}'   v-if="flag=='yuangong'"  label="员工账号" prop="yuangongzhanghao">
          <el-input v-model="ruleForm.yuangongzhanghao" readonly              placeholder="员工账号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}'   v-if="flag=='yuangong'"  label="员工姓名" prop="yuangongxingming">
          <el-input v-model="ruleForm.yuangongxingming"               placeholder="员工姓名" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="flag=='yuangong'"  label="性别" prop="xingbie">
        ...
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}'   v-if="flag=='yuangong'"  label="员工电话" prop="yuangongdianhua">
          <el-input v-model="ruleForm.yuangongdianhua"               placeholder="员工电话" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="flag=='yuangong'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
        ...
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}'   v-if="flag=='yuangong'"  label="职位" prop="zhiwei">
